    ...
    render(){
        ...
        return(
            ...
            <h2>Please select a category for your feedback.</h2>
                <button id="btn1" className="p1btn" type="button">General Feedback</button>
                <button id="btn2" className="p1btn" type="button">Usability Issue</button>
                <button id="btn3" className="p1btn" type="button">Bug Report</button>
                <button id="btn4" className="p1btn" type="button">Vulnerability Report</button>
                <button id="btn5" className="p1btn" type="button">Feature Suggestion</button>
                <button id="p1next" className="p1next" type="button">Next</button>
            </div>
        );
    }
}