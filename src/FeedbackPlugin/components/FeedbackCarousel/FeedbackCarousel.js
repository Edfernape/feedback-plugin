...
export default class FeedbackCarousel extends React.Component{
    constructor(props){
        ...
        this.state = {
            ...
            carouselPlacement: this.setPlacement(this.props.openerPlacement),
            carouselStyles: {},
    ...
    render(){
        ...
        return(
            <div style={finalStyle} className="carousel">
                <button type="button" style={this.state.closerPlacement} onClick={this.closerClicked} className="carouselCloser">&#10006;</button>
                <div>
                    {str1}
                    <button style={{fontSize: this.state.carouselStyles.fontSize}} className="carouselBtn" type="button" onClick={this.carouselClicked}>{str2}</button>
                </div>
                <div className="dotContainer">
                    <span id="b1" className="dot"></span>
                    <span id="b2" className="dot"></span>
                    <span id="b3" className="dot"></span>
                    <span id="b4" className="dot"></span>
                    <span id="b5" className="dot"></span>
                </div>
            </div>
        );
    }
